                    ...
                    <div class="card-body p-4 text-black" style="margin-top: 0px;">
                      <div class="mb-5  text-body">
                        ...
                        <div class="p-4 bg-body-tertiary">
                          <p class="font-italic mb-1">Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur, praesentium distinctio blanditiis voluptas nobis dolores, eveniet facere nisi esse saepe commodi magnam adipisci fugiat. Expedita consectetur at facere itaque rerum!    </p>
                        </div>
                      </div>
